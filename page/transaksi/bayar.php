            ...
            <form method="post" name="autoSumForm" enctype="multipart/form-data">
                <div class="modal-body">
                    <div class="form-group">
                        <label>PPN</label>
                        <input type="number" class="form-control" value="<?php echo $tr['ppn'] ?>"
                            onFocus="startCalc();" onBlur="stopCalc();" name="ppn">
                    </div>
                    <div class="form-group">
                        <label>Diskon</label>
                        <input type="number" class="form-control" value="<?php echo $tr['total_diskon'] ?>"
                            onFocus="startCalc();" onBlur="stopCalc();" name="total_diskon">
                    </div>
                    <div class="form-group">
                        <label>Di Bayar</label>
                        <input type="number" class="form-control" min="{{$subtotaltrue}}" onFocus="startCalc();"
                            onBlur="stopCalc();" value="<?php echo $tr['bayar'] ?>" name="bayar">
                    </div>
                    <div class="form-group">
                        <label>Rp. SUBTOTAL</label>
                        <input type="hidden" value="<?php echo $subtotaltrue ?>" name="sub">
                        <input type="number" class="form-control" value="<?php echo $subtotaltrue ?>" readonly=""
                            name="subtotal">
                    </div>
                    <hr>
                    <div class="form-group">
                        ...
                        <?php endforeach ?>
                        <input type="hidden" class="form-control" value="<?php echo $tr['no_transaksi'] ?>" required
                            name="no_transaksi">
                    </div>
                </div>
